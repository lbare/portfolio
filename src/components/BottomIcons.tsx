    ...
    <div className="absolute top-0 left-0 w-full px-60 pt-4 z-40">
      <div className="flex justify-center items-center p-4 space-x-24">
        <div className="flex flex-col items-center space-y-2 group">
          <button className="w-16 h-16 flex justify-center items-center border-4 bg-neutral-800 border-white shadow-[5px_5px_0_0_rgba(255,255,255,1)] rounded-full transform group-hover:-translate-y-2 transition duration-200">
