...
const NavBar: React.FC<NavBarProps> = ({
  ...
  return (
    <div className="absolute h-1/6 bottom-0 left-0 w-full px-24 z-40">
      <div className="w-full border-3 border-gray-300 h-2/3 rounded-lg flex items-center justify-between overflow-hidden shdow-[10px_10px_0px_0_rgba(255,255,255,1)]">
        {/* Main tabs */}
        <div className="flex h-full bg-neutral-800 py-3 w-full justify-between items-center px-4 space-x-4">
          <button
            ...
            className="flex h-full w-full rounded-l-lg px-6 space-x-4 bg-neutral-900 border-gray-300 border-2 rounded-xl justify-center items-center flex-row"
          >
          ...
          <button
            ...
            className="flex h-full w-full px-4 space-x-4 flex-row bg-neutral-900 border-gray-300 border-2 rounded-xl justify-center items-center hover:bg-neutral-700 transition ease-in-out duration-150"
          >
          ...
          <button
            ...
            className="flex h-full w-full px-4 rounded-r-lg space-x-4 flex-row bg-neutral-900 border-gray-300 border-2 rounded-xl justify-center items-center hover:bg-neutral-700 transition ease-in-out duration-150"
          >
